...
const Header = () => {
  ...
  const {image,setImage,removeBg} = useContext(AppContext)
    ...
    <div className=" flex items-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-10 lg:px-44 sm:mt-20">
      ...
      <div>
        ...
        <p className=" my-6 text-[15px] text-gray-500 ">
          ...
          adipisci tempore ea quae similique <br className=" max-md:hidden" />{" "}
          cupiditate, asperiores ratione distinctio. Odit, ipsam!
        </p>
        <div>
