...
const Navbar = () => {
  ...
  const { credit, setCredit, loadCreditsData, backendUrl } =
    ...
    <div className=" flex items-center justify-between mx-4 py-3 lg:mx-44">
      ...
      {isSignedIn ? (
        <div className=" flex items-center gap-2 sm:gap-3">
          <button onClick={()=>navigate("/buy")} className=" flex items-center gap-2 bg-blue-100 sm:px-7 px-4 py-1.5 sm:p72.5 rounded-full hover:scale-105 transition-all duration-700">
