...
const BuyCredit = () => {
  const { loadCreditsData, resultImage, setResultImage, backendUrl } =
      ...
      <div className=" flex flex-wrap justify-center gap-6 text-left">
        {plans.map((item, index) => (
          ...
          >
            ...
            <button onClick={()=>paymentRazorpay(item.id)} className=" w-full bg-gray-800 mt-8 text-white text-sm rounded-md py-2.5 min-w-52">
              Purchase
            </button>
          </div>
        ))}
