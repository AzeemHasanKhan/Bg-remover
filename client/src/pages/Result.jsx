  ...
  return (
    <div className=" mx-4 my-3 lg:mx-44 mt-14 min-h-[75vh]">
      <div className=" bg-white rounded-lg px-8 py-6 drop-shadow-sm">
        ...
        {/* Buttons */}
        <div className=" flex justify-center sm:justify-end items-center flex-wrap m-6 gap-4 ">
          ...
          <a className=" px-8 py-2.5 text-white text-sm bg-gradient-to-r from-violet-600 to-fuchsia-500 rounded-full hover:scale-105 transition-all duration-700" href="">Donwload Image</a>
        </div>
      </div>
    </div>
  );
